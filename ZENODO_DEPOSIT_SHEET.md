...
|---|---|---|
| **is derived from** | `https://github.com/MichelYsf/rcbsid-paper/tree/DEPOSIT_COMMIT_PLACEHOLDER` | **the commit, not the branch**: the one commit whose tree holds the five Step 2 files byte-for-byte as staged; replaces the inherited 083df8a… link, which belongs to 2.0.0 |

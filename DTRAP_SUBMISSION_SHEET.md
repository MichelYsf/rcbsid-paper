...
| # | file | size | role |
|---|---|---|---|
| 1 | `packages/dtrap/manuscript_anonymous.pdf` | 654,852 B | **main document** |
| 2 | `packages/dtrap/artifact_anonymous.zip` | 570,954 B | supplementary, **not for publication** |
| 3 | `packages/dtrap/source_anonymous.tar.gz` | 98,197 B | supplementary, **not for publication** |

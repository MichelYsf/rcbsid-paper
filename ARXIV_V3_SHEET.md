...
record lineage (doi:10.5281/zenodo.22213264) and supersedes it, and Zenodo
displays a newer-version notice on the superseded record. Title changed
accordingly (previously "CALIBURN: Operationally Calibrated Streaming
Intrusion Detection with Regime-Dependent Conformal Risk Control"). A
companion preprint sharing parts of the same codebase (arXiv:2510.09619)

...
sentence-level claim ledger ships with the artifact. v1 and v2 also cited a
Zenodo DOI that was never minted -- no such deposit existed; the artifact is
being deposited for the first time with v3, and the placeholder is withdrawn.

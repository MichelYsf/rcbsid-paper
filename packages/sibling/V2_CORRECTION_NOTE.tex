...
%
% APPLIED 2026-09-01: the v1 source now lives in packages/sibling/v1_source/
% (fetched from arXiv's public e-print endpoint) and both blocks are already
% inserted in packages/sibling/v2_source/main.tex. The upload package is
% packages/sibling/arxiv_2510_09619_v2_source.tar.gz. This file remains the
% source of the block text. Both blocks are self-contained: no packages
% beyond the LaTeX kernel, no macros defined, nothing that can collide with
% the host preamble.
%
...
% forthcoming), artifact doi:10.5281/zenodo.22638195.]}

...
| S7 ACM manuscript rebuild | done | `paper/main.tex` compiles clean (pdflatex+bibtex ×3, 0 undefined refs, 9 pp `manuscript` layout); every number a manifest-backed macro |
| S8 artifact preparation | done | `PUBLISH_INSTRUCTIONS.md`, `packages/`, nothing published |
| WRAP | done | `SCOPE_DECISIONS.md` (18 corrected incidents), `SUPERSEDED.md`, `CLAIM_LEDGER.md` (gate-checked), `README.md`, `CITATION.cff` |

Governing rule enforced end to end: 362 manifested macros, 0 orphans,
